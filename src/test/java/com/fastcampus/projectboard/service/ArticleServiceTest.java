...
class ArticleServiceTest {
    ...
    void givenArticleInfo_whenSavingArticle_thenSavesArticle() {
        // Given
        given(articleRepository.save(any(Article.class))).willReturn(null); // 반환값이 없다면 willDoNothing 사용

        // When
        sut.saveArticle(ArticleDto.of(LocalDateTime.now(), "Ssg", "title", "content", "hashtag"));
    ...
    void givenArticleId_whenDeletingArticle_thenDeletesArticle() {
        // Given
        willDoNothing().given(articleRepository).delete(any(Article.class)); // 반환값이 없다면 willDoNothing 사용
